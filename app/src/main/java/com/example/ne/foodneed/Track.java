...
public class Track extends AppCompatActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.ConnectionCallbacks,
    ...
    private String trackFoodURL = IPaddress.ip + "trackfood.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnHomepageEditProfile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Track.this,Profile.class);
                startActivity(i);
        ...
        findViewById(R.id.btnHomepageDonateFood).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Track.this,UserHomepage.class);
                startActivity(i);
                overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                finish();
            }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Track.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 1);
        } else {
        ...
        client.get(trackFoodURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    Toast.makeText(Track.this, res, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onResponse(DirectionObject response) {
                try {
                    ...
                    if (response.getStatus().equals("OK")) {
                        ...
                        Toast.makeText(Track.this, "Maps server error!", Toast.LENGTH_SHORT).show();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    protected void onDestroy() {
        try {
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, Track.this);
        } catch (Exception e) {
        }
        super.onDestroy();
    }
    ...
    protected void onResume() {
        ...
        try {
            ...
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, Track.this);
        }catch(Exception e){}
    }
            ...
            final CountDownTimer t = new CountDownTimer(1000,100){
                ...
                public void onFinish() {
                    if(count>1) {
                        ...
                        UserData.id = "";
                        UserData.fid = "0";
                        Intent i = new Intent(Track.this, Login.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(i);
                        finish();
                    }else{
                        count=0;
                        Toast.makeText(Track.this, "Continuously press back button two times to logout!", Toast.LENGTH_SHORT).show();
                    }
                }
            }.start();
        }
