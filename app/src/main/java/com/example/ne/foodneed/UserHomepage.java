...
public class UserHomepage extends AppCompatActivity {
    ...
    Button donate,track,editprofile,selectloc,submit;
    ...
    private String submitFoodURL = IPaddress.ip+"donatefooduser.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donate = (Button) findViewById(R.id.btnHomepageDonateFood);
        track = (Button) findViewById(R.id.btnHomepageTrack);
        editprofile = (Button) findViewById(R.id.btnHomepageEditProfile);
        ...
        track.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(UserHomepage.this,Track.class);
                startActivity(i);
        ...
        editprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UserHomepage.this,Profile.class);
                startActivity(i);
                overridePendingTransition(R.anim.fade_in,R.anim.fade_out);
                finish();
            }
        ...
        findViewById(R.id.selectLocationMap).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(UserHomepage.this,AddLocation.class);
                startActivity(i);
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if((rice.isEmpty() && sabji.isEmpty() && roti.isEmpty()) || (rice.equals("0") && sabji.equals("0") && roti.equals("0"))) {
                    Toast.makeText(UserHomepage.this, "Enter some food to donate!", Toast.LENGTH_SHORT).show();
                }else{
                    if(loc.isEmpty() || lat.isEmpty() || lon.isEmpty()){
                        Toast.makeText(UserHomepage.this, "Select location of food!", Toast.LENGTH_SHORT).show();
                    }else {
    ...
    private void functionSendDonation(){
        ...
        final ProgressDialog pDialog = ProgressDialog.show(UserHomepage.this,"Processing","connecting server...",true,false);
        ...
        client.get(submitFoodURL, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                if(res.equals("200")){
                    Toast.makeText(UserHomepage.this, "Donation successful!", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                pDialog.dismiss();
                Toast.makeText(UserHomepage.this, "Connectivity failed! Try again.", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            final CountDownTimer t = new CountDownTimer(1000,100){
                ...
                public void onFinish() {
                    if(count>1) {
                        ...
                        UserData.id = "";
                        UserData.fid = "0";
                        Intent i = new Intent(UserHomepage.this, Login.class);
                        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(i);
                        finish();
                    }else{
                        count=0;
                        Toast.makeText(UserHomepage.this, "Continuously press back button two times to logout!", Toast.LENGTH_SHORT).show();
                    }
                }
            }.start();
        }
